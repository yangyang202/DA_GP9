...
pd.set_option('display.max_rows', 122)  # to preview the whole of 361 rows, if delete it wont preview the whole 361 rows
ranges = (df.iloc[2:122, :34])  # the start printing from rows 241 to 361 and from 1 to 18

calculated = (df.iloc[2:122, :34].sum(axis=0))  # Sum of whole value from 241-361 & from 1-18
